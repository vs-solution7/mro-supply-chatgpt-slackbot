...
app.command("/mrobot", async ({ command, ack, respond, say }) => {
  await ack();
  ...
  if (action === "start") {
    ...
    await say("Happy to assist you! :call_me_hand: See you again!");
    await respond(
      "You have stopped the conversation with MROSupply-GPT-Assistance in this channel."
    );
  } else {
    await respond(
